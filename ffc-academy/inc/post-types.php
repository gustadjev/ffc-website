...
function ffc_register_content_types(): void {
	...
	register_taxonomy( 'ffc_team', array( 'ffc_game', 'ffc_score', 'ffc_coach' ), array(
	...
	register_taxonomy( 'ffc_season', array( 'ffc_game', 'ffc_score' ), array(
	...
	register_taxonomy( 'ffc_gallery_category', 'ffc_gallery', array(
	...
	register_taxonomy( 'ffc_sponsor_tier', 'ffc_sponsor', array(
