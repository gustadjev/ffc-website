...
$footer_social_links = ffc_social_links_markup( 'social-icons social-icons--footer', true );
?>
<footer class="site-footer">
	...
	<div class="container site-footer__top">
		...
		<div class="site-footer__facility">
			...
			<?php echo $footer_social_links; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
		</div>
	</div>
